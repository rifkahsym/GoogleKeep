...
const RemindersScreen = ({ navigation, toggleSidebar }) => {
    ...
    return (
        <SafeAreaView style={styles.container(darkMode)}>
            <View style={styles.topBar(darkMode)}>
                ...
                <Text style={styles.title(darkMode)}>Reminders</Text>
            ...
            <View style={styles.content}>
                <Ionicons name="notifications" size={50} color={darkMode ? 'lightgray' : 'gray'} />
                <Text style={styles.message(darkMode)}>Notes with upcoming reminders appear here</Text>
            </View>
        </SafeAreaView>
    );
};
